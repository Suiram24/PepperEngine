...
void vk::CPeTexture::Free() {
    vkFreeDescriptorSets(device, descriptorPool, 1, &descriptorSet);
}

VkDescriptorSet& vk::CPeTexture::GetTextureDescriptorSet() {
    return descriptorSet;
}

void vk::CPeTexture::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
uint32_t vk::CPeTexture::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
VkCommandBuffer vk::CPeTexture::beginSingleTimeCommands() {
...
void vk::CPeTexture::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
VkImageView vk::CPeTexture::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels) {
...
void vk::CPeTexture::createImage(
    uint32_t width,
    uint32_t height,
    uint32_t mipLevels,
...
void vk::CPeTexture::transitionImageLayout(
    VkImage image,
    VkFormat format,
...
void vk::CPeTexture::copyBufferToImage(
    VkBuffer buffer,
    VkImage image,
    uint32_t width,
    uint32_t height
...
void vk::CPeTexture::createTextureImage(const char* path) {
...
void vk::CPeTexture::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
...
void vk::CPeTexture::createTextureDescriptorSet()
{

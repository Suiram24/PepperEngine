...
namespace pedemo {
	...
	void DemoCollisionSystem::LoadLevel()
	{
		...
		pephy::CPeRigidBody* rigidbodyComp3 = forceSystem->CreateRigidBodyComponent(entity3, 50);
		...
		pephy::CPeColliderComponent* col3 = colliderSystem->CreateColliderComponent(*entity3, 1);
		...
		col3->AddPrimitive(colliderSystem->CreateSphereShape(*entity3, 1));

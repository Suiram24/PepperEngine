...
VkDescriptorPool& vk::CPeVulkanRenderer::getDescriptorPool() {
    return descriptorPool;
}

VkDescriptorSetLayout& vk::CPeVulkanRenderer::getUniformDescriptorSetlayout()
{
    return uniformDescriptorSetLayout;
}

VkDescriptorSetLayout& vk::CPeVulkanRenderer::getTextureDescriptorSetlayout()
{
...
void vk::CPeVulkanRenderer::DestroyTextures()
{
    for (auto& texture : textureObjects) {
        texture->Destroy();
    }
